  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    transitionOut: function(positive) {
      ...
      if((positive === true) || (this.y < 0)) {
        ...
        this.el.style[ionic.CSS.TRANSFORM] = 'translate3d(' + (window.innerWidth * -1.5) + 'px ,' + this.x  + ', 0) rotate(' + rotateTo + 'rad)';
    ...
    _doDrag: function(e) {
      ...
      this.y = this.startY + (e.gesture.deltaX * 0.4);

      this.el.style[ionic.CSS.TRANSFORM] = 'translate3d(' + this.y + 'px, ' + this.x  + 'px, 0) rotate(' + (this.rotationAngle || 0) + 'rad)';
    },
